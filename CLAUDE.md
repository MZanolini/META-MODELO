...
- A lógica da auditoria de processo vive em `auditoria/audit.py`; os critérios que ela verifica vivem em `auditoria/Criterios_Skill_Auditoria_v0_2.md` e não são redefinidos fora daquele documento.
